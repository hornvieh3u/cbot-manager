  ...
  <VCard title="Headlines">
    <VCardText class="d-flex flex-column gap-y-8">
      ...
      <div>
        ...
        <p class="mt-2 mb-0">
          font-size: 3.75rem / line-height: 4.5rem / font-weight: 500
        </p>
      </div>
      ...
      <div>
        ...
        <p class="mt-1 mb-0">
          font-size: 3rem / line-height: 3.5rem / font-weight: 500
        </p>
      </div>
      ...
      <div>
        ...
        <p class="mt-1 mb-0">
          font-size: 2.125rem / line-height: 2.625rem / font-weight: 500
        </p>
      </div>
